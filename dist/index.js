...
var registerBuilderComponents = function () { return __awaiter(void 0, void 0, void 0, function () {
    var Builder, ButtonModule, ButtonComponent, error_1, errorMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("@builder.io/react")); })];
            case 1:
                Builder = (_a.sent()).Builder;
                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("./components/Button")); })];
            case 2:
                ButtonModule = _a.sent();
                ButtonComponent = ButtonModule.Button;
                if (Builder &&
                    Builder.registerComponent &&
                    (ButtonComponent === null || ButtonComponent === void 0 ? void 0 : ButtonComponent.builderSettings)) {
                    Builder.registerComponent(ButtonComponent, ButtonComponent.builderSettings);
...
exports.registerBuilderComponents = registerBuilderComponents;
// Import components and tokens for default export
var Button_2 = require("./components/Button");
var colors_2 = require("./tokens/colors");
