...
exports.buttonBaseClasses = exports.buttonSizeMappings = exports.buttonColorMappings = exports.generateColorClasses = exports.cssVariables = exports.tailwindColors = exports.colors = void 0;
exports.colors = {
...
exports.cssVariables = {
    // Primary colors
    "--color-primary-50": exports.colors.primary[50],
    "--color-primary-100": exports.colors.primary[100],
    "--color-primary-500": exports.colors.primary[500],
    "--color-primary-600": exports.colors.primary[600],
    "--color-primary-700": exports.colors.primary[700],
    // Secondary colors
    "--color-secondary-50": exports.colors.secondary[50],
    "--color-secondary-100": exports.colors.secondary[100],
    "--color-secondary-200": exports.colors.secondary[200],
    "--color-secondary-500": exports.colors.secondary[500],
    "--color-secondary-600": exports.colors.secondary[600],
    "--color-secondary-700": exports.colors.secondary[700],
    "--color-secondary-800": exports.colors.secondary[800],
    "--color-secondary-900": exports.colors.secondary[900],
    // Semantic colors
    ...
    "--color-black": exports.colors.black,
    "--color-transparent": exports.colors.transparent,
};
// Tailwind utility class generator helpers
var generateColorClasses = function (colorName, shade) {
    var baseShade = shade || 500;
    return {
        background: "bg-".concat(colorName, "-").concat(baseShade),
        text: "text-".concat(colorName, "-").concat(baseShade),
        border: "border-".concat(colorName, "-").concat(baseShade),
        ring: "ring-".concat(colorName, "-").concat(baseShade),
    };
};
exports.generateColorClasses = generateColorClasses;
// Button-specific color mappings
exports.buttonColorMappings = {
    primary: {
        ...
        disabled: "disabled:bg-secondary-300 disabled:text-secondary-500 disabled:border-secondary-300",
    },
    secondary: {
        ...
        disabled: "disabled:bg-secondary-50 disabled:text-secondary-400 disabled:border-secondary-200",
    },
    outline: {
        ...
        focus: "focus:ring-primary-500/50",
        disabled: "disabled:bg-transparent disabled:text-secondary-400 disabled:border-secondary-300",
    },
    ghost: {
        ...
        focus: "focus:ring-primary-500/50",
        disabled: "disabled:bg-transparent disabled:text-secondary-400 disabled:border-transparent",
    },
};
// Size mappings
exports.buttonSizeMappings = {
    small: {
...
exports.default = {
    ...
    tailwindColors: exports.tailwindColors,
    cssVariables: exports.cssVariables,
    generateColorClasses: exports.generateColorClasses,
    buttonColorMappings: exports.buttonColorMappings,
    buttonSizeMappings: exports.buttonSizeMappings,
    buttonBaseClasses: exports.buttonBaseClasses,
};
