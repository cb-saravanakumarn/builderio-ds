...
describe("SButton Component", () => {
  ...
  it("renders the neutral button correctly", () => {
    ...
    const buttonElement = screen.getByRole("button", { name: /neutral button/i });
    expect(buttonElement).toBeInTheDocument();
  ...
  it("renders the warning button correctly", () => {
    ...
    const buttonElement = screen.getByRole("button", { name: /warning button/i });
    expect(buttonElement).toBeInTheDocument();
  ...
  it("renders the success button correctly", () => {
    ...
    const buttonElement = screen.getByRole("button", { name: /success button/i });
    expect(buttonElement).toBeInTheDocument();
  ...
  it("applies the correct size class when size is regular", () => {
    ...
    const buttonElement = screen.getByRole("button", { name: /regular button/i });
  ...
  it("renders the loading state correctly", () => {
    ...
    expect(screen.getByRole("button")).toContainHTML('<svg class="s-animate-spin');
  });
  ...
  it("renders a link when asChild prop is true", () => {
    ...
    expect(linkElement).toHaveClass("s-btn");
  ...
  it("renders the icon on the left when iconPosition is left", () => {
    render(
      <SButton icon={<span data-testid="test-icon">Icon</span>} iconPosition="left">
        Button with Left Icon
      </SButton>
    );
    const buttonElement = screen.getByRole("button", { name: /button with left icon/i });
  ...
  it("renders the icon on the right when iconPosition is right", () => {
    render(
      <SButton icon={<span data-testid="test-icon">Icon</span>} iconPosition="right">
        Button with Right Icon
      </SButton>
    );
    const buttonElement = screen.getByRole("button", { name: /button with right icon/i });
    const iconElement = screen.getByTestId("test-icon");
    expect(buttonElement).toContainElement(iconElement);
  ...
  it("applies the correct rounded class", () => {
    ...
    const buttonElement = screen.getByRole("button", { name: /rounded button/i });
  ...
  it("does not fire onClick when disabled", () => {
    const handleClick = vi.fn();
    render(<SButton onClick={handleClick} disabled>Disabled Button</SButton>);
    const buttonElement = screen.getByRole("button", { name: /disabled button/i });
  ...
  it("does not fire onClick when loading", () => {
    const handleClick = vi.fn();
    render(<SButton onClick={handleClick} loading>Loading Button</SButton>);
    const buttonElement = screen.getByRole("button", { name: /loading button/i });
  ...
  it("renders with the default type of button", () => {
    ...
    const buttonElement = screen.getByRole("button", { name: /default type button/i });
