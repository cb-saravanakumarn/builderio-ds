...
const meta: Meta<SDrawerProps> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					'A drawer component that slides in from the edge of the screen. Uses compound component pattern for better organization and flexibility.',
			},
		},
	},
};
  ...
  >
						...
						<div className="p-6">
							<div className="space-y-4">
								...
								<div className="rounded-lg bg-slate-100 p-4">
									...
									<pre className="overflow-x-auto rounded-md bg-slate-800 p-4 text-sm text-slate-50">
										{codeSnippet}
									</pre>
								</div>
							</div>
	...
	parameters: {
		docs: {
			description: {
				story:
					'Interactive playground for the SDrawer component with state management.',
			},
		},
	},
};
